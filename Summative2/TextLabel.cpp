...
/*
* Function - TextLabel
* TextLabel Constructor to make new labels
...
TextLabel::TextLabel(std::string text, std::string font)
{
	...
	program = shaderLoader.CreateProgram("textVSt.vs", "textFS.fs");

	glm::mat4 projection = glm::ortho(0.0f, static_cast<GLfloat>(1200), 0.0f, static_cast<GLfloat>(900));
